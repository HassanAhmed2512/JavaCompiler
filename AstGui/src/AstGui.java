 ...
 * @author Hanood
 */
public class AstGui extends javax.swing.JFrame {
...
//           stt = stt.replaceFirst("style=\"bold\"", "style=\"regular\"");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        // get current directory path and open the file parse.png
        String currentDir = System.getProperty("user.dir");
        System.out.println("Current dir using System:" + currentDir);
        File file = new File(currentDir + "\\Parse.png");
        try {
            Desktop.getDesktop().open(file);
        }catch (IOException ex){
            Logger.getLogger(AstGui.class.getName()).log(Level.SEVERE,null,ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AstGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
